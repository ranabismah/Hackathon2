  ...
  return (
    ...
    <div className="min-h-screen w-full flex flex-col bg-white items-center">
      ...
      <div className="h-full md:h-[316px] w-[90%] md:w-[1440px] flex flex-col items-center justify-center">
        <div className="relative md:h-[316px] w-[90%] md:w-[1440px]">
      ...
      <div className="py-12 w-[90%] md:w-[1440px] flex flex-col items-center space-y-8">
        <div className="text-center w-[90%] md:w-[680px]">
        ...
        <div className="flex flex-col md:flex-row justify-between w-[90%] md:w-[1050px] space-y-8 md:space-y-0">
          {/* Contact Information */}
